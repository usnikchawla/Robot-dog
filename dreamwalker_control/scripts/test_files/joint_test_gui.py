...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButtonPublish = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.LegLabel = QtWidgets.QLabel(self.centralwidget)
        ...
        self.labelShoulderJointValue = QtWidgets.QLabel(self.centralwidget)
        ...
        self.labelLimbJointValue = QtWidgets.QLabel(self.centralwidget)
        ...
        self.labelKneeJointValue = QtWidgets.QLabel(self.centralwidget)
        ...
        self.radioButtonFrontLeft = QtWidgets.QRadioButton(self.splitter)
        self.radioButtonFrontLeft.setObjectName(_fromUtf8("radioButtonFrontLeft"))
        self.radioButtonFrontRight = QtWidgets.QRadioButton(self.splitter)
        self.radioButtonFrontRight.setObjectName(_fromUtf8("radioButtonFrontRight"))
        self.radioButtonBackLeft = QtWidgets.QRadioButton(self.splitter)
        self.radioButtonBackLeft.setObjectName(_fromUtf8("radioButtonBackLeft"))
        self.radioButtonbackRight = QtWidgets.QRadioButton(self.splitter)
